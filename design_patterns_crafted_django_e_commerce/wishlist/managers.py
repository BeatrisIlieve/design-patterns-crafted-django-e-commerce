...
from design_patterns_crafted_django_e_commerce.inventory.models import (Inventory,)
...
class WishlistManager(models.Manager):
    ...
    def add_product_to_wishlist(self, product, user):
        self.create(product=product, user=user)

        return "Product has been added to wishlist"

    def remove_product_from_wishlist(self, product, user):
