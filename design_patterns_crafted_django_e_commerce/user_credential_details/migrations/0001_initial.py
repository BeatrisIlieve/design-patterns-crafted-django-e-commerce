...
import design_patterns_crafted_django_e_commerce.user_credential_details.managers
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='UserCredentialDetails',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('password', models.CharField(max_length=128, verbose_name='password')),
                ('last_login', models.DateTimeField(blank=True, null=True, verbose_name='last login')),
                ('is_superuser', models.BooleanField(default=False, help_text='Designates that this user has all permissions without explicitly assigning them.', verbose_name='superuser status')),
                ('email', models.EmailField(error_messages={'invalid': 'Please enter a valid email address'}, max_length=254, unique=True)),
            ...
            managers=[
                ('objects', design_patterns_crafted_django_e_commerce.user_credential_details.managers.UserCredentialDetailsManager()),
            ],
        ),
    ]
